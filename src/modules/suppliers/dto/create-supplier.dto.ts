...
export class CreateSupplierDto {
  ...
  @MaxLength(100, { message: 'Nome do responsável deve ter no máximo 100 caracteres' })
  responsavel?: string;
  ...
  @MaxLength(20, { message: 'Celular do responsável deve ter no máximo 20 caracteres' })
